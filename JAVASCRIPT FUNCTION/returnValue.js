// Definisi fungsi multiply yang mengembalikan nilai hasil kali dua angka
...
alert("Hasil dari multiply(2, 3) adalah: " + hasil1);
alert("Hasil dari multiply(9, 9) adalah: " + hasil2);
alert("Hasil dari multiply(5, 4) adalah: " + hasil3);
